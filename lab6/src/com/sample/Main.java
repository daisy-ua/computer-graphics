...
public class Main extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        TextureLoader t = new TextureLoader("source/background.jpg", myCanvas3D);
        Background trainerBackground =  new Background(t.getImage());

        Scene trainerScene = null;
        try{
            trainerScene = f.load("source/fish.obj");
        }
        catch (Exception e){
...
//        setToMyDefaultAppearance(ventralFinApp, new Color3f(0.9f, 0.0f, 0.0f));
        Texture v_texture = new TextureLoader("source/tail_texture.jpg", "RGB", new Container()).getTexture();
        ventralFinApp.setTexture(v_texture);
...
//        setToMyDefaultAppearance(finApp, new Color3f(0.9f, 0.0f, 0.0f));
        Texture fin_texture = new TextureLoader("source/tail_texture.jpg", "RGB", new Container()).getTexture();
        finApp.setTexture(fin_texture);
...
//        setToMyDefaultAppearance(tailApp, new Color3f(0.9f, 0.0f, 0.0f));
        Texture tail_texture = new TextureLoader("source/tail_texture.jpg", "RGB", new Container()).getTexture();
        tailApp.setTexture(tail_texture);
        ...
        Texture body_texture = new TextureLoader("source/texture.jpg", "RGB", new Container()).getTexture();
        bodyApp.setTexture(body_texture);
